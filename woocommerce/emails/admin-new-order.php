<?php $shipping_value = wc_price($order->get_meta('shipping_value', true));
    $shipping_total_value =  wc_price($order->get_meta('shipping_total_value', true)) ;
?>
<!DOCTYPE html>
                                                            ...
                                                            <td style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:50px;">
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <div style="font-size: 16px; font-family: 'Gotham Bold', Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                                        <p style="margin: 0; font-size: 16px; letter-spacing: 5px;">
                                                                            <span style="font-size:20px;">Novo
                                                                                Pedido</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                                    ...
                                                                    <table border="0" cellpadding="10" cellspacing="0" style="border: 1px solid rgba(0,0,0,.1); margin: 0 -1px 24px 0; text-align: left; width: 100%; border-collapse: separate; border-radius: 5px; border: 1px solid rgba(0, 0, 0, 0.1); margin: 0 -1px 24px 0; text-align: left; width: 100%; border-collapse: collapse; border-radius: 5px;">
                                                                        <thead>
                                                                            <tr style="background: #93583a; border: none !important; border-collapse: collapse; font-size: 16px;">
                                                                                ...
                                                                                <th align="center">
                                                                                    <div style="color: #fff; font-family: 'Gotham Bold', Calibri, sans-serif;">Status
                                                                                    </div>
                                                                                </th>
                                                                                <th align="center">
                                                                        ...
                                                                        <tbody style="border-color: inherit; border-style: solid; border-width: 0;">
                                                                            ...
                                                                            <?php foreach ($order->get_items() as $item_id => $items) :
                                                                                ...
                                                                                <?php
                                                                                $discount_price = ($order->get_item_meta($item_id, '_price_with_discount', true));
                                                                                $discount_price = !empty($discount_price) ? wc_price($discount_price) : null;
                                                                                ...
                                                                                <tr style="font-size: 16px; font-family: Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                                                    ...
                                                                                    <td align="center" data-title="Total" style="font-weight: bold; padding: 1em !important; border: none !important; border-collapse: collapse;">
                                                                                        <p style="font-size: 16px; font-family: 'Gotham Bold', Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                                                            ...
                                                                                            <span><?php echo !empty($discount_price) ? "<s>{$wc_price}</s> {$discount_price}" : wc_price($product->get_price()); ?></span>
                                                                                        </p>
                                                                        ...
                                                                        <thead>
                                                                            <tr style="background: #93583a; border: none !important; border-collapse: collapse; font-size: 16px;">
                                                                                <th align="center">
                                                                                    <div style="color: #fff; font-family: 'Gotham Bold', Calibri, sans-serif !important;">
                                                                                        Número do Pedido
                                                                                    </div>
                                                                                </th>
                                                                                <th align="center">
                                                                                ...
                                                                                <td align="center" data-title="Total" style="font-weight: bold; padding: 1em !important; border: none !important; border-collapse: collapse;" colspan="2">
                                                                                    <p style="font-size: 16px; font-family: 'Gotham Bold', Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                                                        ...
                                                                                        <?php if ($order->get_discount_total()) : ?>
                                                                                            ...
                                                                                            <?php endif; ?>
                                                                                            <br><span>Frete: <?php echo ($order->get_total_shipping() > 0) ?  $shipping_value . "(" . $shipping_total_value . ")" : "<font color='#FF0000'>Frete Grátis</font> ( $shipping_value )" ?></span>
                                                                                            <br><span>Total: <?php echo wc_price($order->get_total());  ?>
                                                                                    </p></span>
                                                                                    </p>
                                                        ...
                                                        <tbody>
                                                            <tr style="box-sizing: border-box;">
                                                                <td valign="top" width="50%" style="box-sizing: border-box; text-align: left; font-family: 'Gotham Bold', Calibri, sans-serif !important; border: 0; padding: 0;">
                                                                    <h2 style="box-sizing: border-box;  color: #93583a; display: block; font-family: 'Gotham Bold', Calibri, sans-serif !important; font-size: 18px; font-weight: bold; line-height: 130%; margin: 0 0 18px; text-align: left;">
                                                                        Endereço de faturamento</h2>

                                                                    <address class="address" style="box-sizing: border-box; padding: 12px; color: #636363; border: 1px solid #e5e5e5; font-size: 16px;">
                                                                        <?php echo $order->get_billing_first_name() . " " . $order->get_billing_last_name() ?><br style="box-sizing: border-box;"><br style="box-sizing: border-box;"><br style="box-sizing: border-box;"><?php echo $order->get_billing_city() ?>, <?php echo $order->get_billing_state() ?>, <?php echo $order->get_billing_address_1(); ?>, <?php echo $order->get_meta('_billing_number', true); ?><?php echo  !empty($order->get_billing_address_2()) ? ", " . $order->get_billing_address_2() : "" ?><br style="box-sizing: border-box;"><?php echo $order->get_billing_postcode() ?>
                                                                ...
                                                                <td valign="top" width="50%" style="box-sizing: border-box; text-align: left; font-family: 'Gotham Bold', Calibri, sans-serif !important; padding: 0;">
                                                                    ...
                                                                    <address class="address" style="box-sizing: border-box; padding: 12px; color: #636363; border: 1px solid #e5e5e5; font-size: 16px;">
                                                                        <?php echo $order->get_shipping_first_name() . " " . $order->get_shipping_last_name() ?><br style="box-sizing: border-box;"><br style="box-sizing: border-box;"><br style="box-sizing: border-box;"><?php echo $order->get_shipping_city() ?>, <?php echo $order->get_shipping_state() ?>, <?php echo $order->get_shipping_address_1(); ?>, <?php echo $order->get_meta('_shipping_number', true); ?><?php echo  !empty($order->get_shipping_address_2()) ? ", " . $order->get_shipping_address_2() : "" ?><br style="box-sizing: border-box;"><?php echo $order->get_shipping_postcode() ?>
                                                                        <br style="box-sizing: border-box;"><?php echo  $order->get_billing_email() ?>
                                                                    </address>
                                                                </td>
                                                            </tr>
