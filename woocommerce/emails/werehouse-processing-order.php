                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 5px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;" width="100%">
                                                    ...
                                                    <?php if ($order->get_meta('_shipping_gift_order', true)) : ?>
                                                            ...
                                                            <tr>
                                                                <td style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:50px;">
                                                                    <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                        <div style="font-size: 16px; font-family: 'Gotham Bold', Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: red; line-height: 1.2;">
                                                                            <p style="margin: 0; font-size: 16px;">
                                                                                <span style="font-size:24px;">Este pedido é para presente.</span>
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                ...
                                                                <td style="padding-left:10px;">
                                                                    <div style="font-family: sans-serif">
                                                                        <div style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                                            <p style="margin: 0; font-size: 12px;"><span style="font-size:16px;"><strong>De: </strong><?php echo $order->get_meta('_shipping_gift_from', true); ?></span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table class="text_block" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                            <tr>
                                                                <td style="padding-top:5px;padding-left:10px;">
                                                                    <div style="font-family: sans-serif">
                                                                        <div style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                                            <p style="margin: 0; font-size: 12px;"><span style="font-size:16px;"><strong>Para: </strong><?php echo $order->get_meta('_shipping_gift_to', true); ?></span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                        ...
                                                        <table class="text_block" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                            <tr>
                                                                <td style="padding-top:5px;padding-left:10px;">
                                                                    <div style="font-family: sans-serif">
                                                                        <div style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                                            <p style="margin: 0; font-size: 12px;"><span style="font-size:16px;"><strong>Mensagem: </strong><?php echo $order->get_meta('_shipping_gift_message', true); ?></span></p>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            ...
                                                            <td style="padding-bottom:10px;padding-left:10px;padding-right:10px;padding-top:50px;">
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <div style="font-size: 16px; font-family: 'Gotham Bold', Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                                        <p style="margin: 0; font-size: 16px;">
                                                                            <span style="font-size:20px;">Pedido Está
                                                                                sendo Processado</span>
                                                                        </p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                                    ...
                                                                    <table border="0" cellpadding="10" cellspacing="0" style="border: 1px solid rgba(0,0,0,.1); margin: 0 -1px 24px 0; text-align: left; width: 100%; border-collapse: separate; border-radius: 5px; border: 1px solid rgba(0, 0, 0, 0.1); margin: 0 -1px 24px 0; text-align: left; width: 100%; border-collapse: collapse; border-radius: 5px;">
                                                                        <thead>
                                                                            <tr style="background: #93583a; border: none !important; border-collapse: collapse; font-size: 16px;">
                                                                                <th align="center">
                                                                                    <div style="color: #fff; font-family: 'Gotham Bold', Calibri, sans-serif;">
                                                                                        Cervejaria
                                                                                    </div>
                                                                                </th>
                                                                                <th align="center">
                                                                                ...
                                                                                <tr style="font-size: 16px; font-family: Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                                                    <td align="center" data-title="Pedido" style="font-weight: bold; padding: 1em !important; font-family: 'Gotham Bold';  border: none !important; border-collapse: collapse;">
                                                                                        <p style="font-size: 16px; font-family: 'Gotham Bold', Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2; line-height: 1.5em; padding: 1em !important;">
                                                                                            <?php echo get_post(get_post_meta($product->get_id(), '_supplier_id', true))->post_title ?>
                                                                                        </p>
                                                                                    </td>
                                                                                    <td align="center" data-title="Pedido" style="font-weight: bold; padding: 1em !important; font-family: 'Gotham Bold';  border: none !important; border-collapse: collapse;">
                                                                                        <p style="font-size: 16px; font-family: 'Gotham Bold', Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2; line-height: 1.5em; padding: 1em !important;">
                                                                                    ...
                                                                                    <td align="center" data-title="Total" style="font-weight: bold; padding: 1em !important; border: none !important; border-collapse: collapse;">
                                                                                        <p style="font-size: 16px; font-family: 'Gotham Bold', Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                                                            <span><?php echo get_post_meta($product->get_id(), '_transport_type', true) == 1 ? 'Sim' : 'Não'  ?></span>
                                                                                        </p>
                                                                                    ...
                                                                                    <td align="center" data-title="qtd" style="font-weight: bold; padding: 1em !important; border: none !important; border-collapse: collapse;">
                                                                                        <p style="font-size: 16px; font-family: 'Gotham Bold', Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                                                            <span><?php echo get_post_meta($product->get_id(), '_bar_code', true) ?></span>
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                            <?php endforeach; ?>
                                                    ...
                                                    <table border="0" cellpadding="10" cellspacing="0" style="box-sizing: border-box; border: 1px solid rgba(0, 0, 0, 0.1); margin: 0 -1px 24px 0; text-align: left; width: 100%; border-collapse: collapse; border-radius: 5px;">
                                                        <thead style="box-sizing: border-box;">
                                                            <tr style="box-sizing: border-box; background: #93583a; border-collapse: collapse; border: none; font-size: 16px;">
                                                                <th align="center" style="box-sizing: border-box;">
                                                                    <div style="box-sizing: border-box; color: #fff; font-family: 'Gotham Bold', Calibri, sans-serif;">
                                                                        Pedido
                                                                    </div>
                                                                </th>
                                                                <th align="center" style="box-sizing: border-box;">
                                                                ...
                                                                <th align="center" style="box-sizing: border-box;" colspan="2">
                                                                    <div style="box-sizing: border-box; color: #fff; font-family: 'Gotham Bold', Calibri, sans-serif;">
                                                                        Total
                                                                    </div>
                                                                </th>
                                                        ...
                                                        <tfoot style="border-color: inherit; border-style: solid; border-width: 0;">
                                                            <tr style="font-size: 16px; font-family: Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                                <td align="center" data-title="Pedido" style="font-weight: bold; padding: 1em !important; font-family: 'Gotham Bold', Calibri, sans-serif;  border: none !important; border-collapse: collapse;">
                                                                    <p style="font-size: 16px; font-family: 'Gotham Bold', Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2; line-height: 1.5em; padding: 1em !important;">
                                                                        # <?php echo $order->ID ?> </p>
                                                                </td>
                                                                ...
                                                                <td align="center" data-title="Total" style="font-weight: bold; padding: 1em !important; border: none !important; border-collapse: collapse;" colspan="2">
                                                                    <p style="font-size: 16px; font-family: 'Gotham Bold', Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                                        <span>SubTotal:
                                                                            <?php echo wc_price($order->get_total() - $order->get_total_tax() - $order->get_total_shipping() - $order->get_shipping_tax()) ?></span>
                                                                ...
                                                                <td align="center" data-title="qtd" style="font-weight: bold; padding: 1em !important; border: none !important; border-collapse: collapse;">
                                                                    <p style="font-size: 16px; font-family: 'Gotham Bold', Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                                        <span><?php echo $order->get_item_count();  ?>
                                                                    </p></span><br>
                                                    ...
                                                    <table id="addresses" cellspacing="0" cellpadding="0" border="0" style="box-sizing: border-box; width: 100%; vertical-align: top; margin-bottom: 40px; padding: 0;">
                                                        <tbody>
                                                            <tr style="box-sizing: border-box;">
                                                                <td valign="top" width="50%" style="box-sizing: border-box; text-align: left; font-family: 'Gotham Bold', Calibri, sans-serif !important; border: 0; padding: 0;">
                                                                    <h2 style="box-sizing: border-box;  color: #93583a; display: block; font-family: 'Gotham Bold', Calibri, sans-serif !important; font-size: 16px; font-weight: bold; line-height: 130%; margin: 0 0 18px; text-align: left;">
                                                                        Endereço de faturamento</h2>

                                                                    <address class="address" style="box-sizing: border-box; padding: 12px; color: #636363; font-size: 16px; border: 1px solid #e5e5e5;">
                                                                        <?php echo $order->get_billing_first_name() . " " . $order->get_billing_last_name() ?><br style="box-sizing: border-box;"><br style="box-sizing: border-box;"><br style="box-sizing: border-box;"><?php echo $order->get_billing_city() ?>,
                                                                        <?php echo $order->get_billing_state() ?>,
                                                                        <?php echo $order->get_billing_address_1(); ?>,
                                                                        <?php echo $order->get_meta('_billing_number', true); ?><?php echo  !empty($order->get_billing_address_2()) ? ", " . $order->get_billing_address_2() : "" ?><br style="box-sizing: border-box;"><?php echo $order->get_billing_postcode() ?>
                                                                        <br style="box-sizing: border-box;"><?php echo  $order->get_billing_email() ?>
                                                                    </address>
                                                                </td>
                                                                <td valign="top" width="50%" style="box-sizing: border-box; text-align: left; font-family: 'Gotham Bold', Calibri, sans-serif !important; padding: 0;">
                                                                    <h2 style="box-sizing: border-box;  color: #93583a; display: block; font-family: 'Gotham Bold', Calibri, sans-serif !important; font-size: 16px; font-weight: bold; line-height: 130%; margin: 0 0 18px; text-align: left;">
                                                                        Endereço de entrega</h2>

                                                                    <address class="address" style="box-sizing: border-box; padding: 12px; color: #636363; font-size: 16px; border: 1px solid #e5e5e5;">
                                                                        <?php echo $order->get_shipping_first_name() . " " . $order->get_shipping_last_name() ?><br style="box-sizing: border-box;"><br style="box-sizing: border-box;"><br style="box-sizing: border-box;"><?php echo $order->get_shipping_city() ?>,
                                                                        <?php echo $order->get_shipping_state() ?>,
                                                                        <?php echo $order->get_shipping_address_1(); ?>,
                                                                        <?php echo $order->get_meta('_shipping_number', true); ?><?php echo  !empty($order->get_shipping_address_2()) ? ", " . $order->get_shipping_address_2() : "" ?><br style="box-sizing: border-box;"><?php echo $order->get_shipping_postcode() ?>
                                                                        <br style="box-sizing: border-box;"><?php echo  $order->get_billing_email() ?>
                                                                    </address>
                                                                </td>
                                                            </tr>
