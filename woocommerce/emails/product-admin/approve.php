...
@font-face {
      ...
      src: url("<?php echo CDCPA_URL; ?>assets/fonts/gotham-fonts-master/Gotham-Bold.eot");
      src: local("Gotham-Bold"), url("<?php echo CDCPA_URL; ?>assets/fonts/gotham-fonts-master/Gotham-Bold.eot?#iefix") format("embedded-opentype"),
        url("<?php echo CDCPA_URL; ?>assets/fonts/gotham-fonts-master/Gotham-Bold.woff2") format("woff2"),
        url("<?php echo CDCPA_URL; ?>assets/fonts/gotham-fonts-master/Gotham-Bold.woff") format("woff"),
        url("<?php echo CDCPA_URL; ?>assets/fonts/gotham-fonts-master/Gotham-Bold.ttf") format("truetype"),
        url("<?php echo CDCPA_URL; ?>assets/fonts/gotham-fonts-master/Gotham-Bold.svg#Gotham-Bold") format("svg");
      font-weight: bold;
      font-style: normal;
      font-display: block;
    }
														...
														<tr>
															<td
																...
																<div style="line-height: 10px">
																	<img src="<?php echo CDCPA_URL . "assets/images/logo.png"; ?>"
																...
																<div style="font-family: sans-serif">
																	<div
																		...
																		<p style="margin: 0; font-size: 14px;">
																			<span style="color: #93583a; font-size: 18px;"><strong>Produto
															...
															<td
																...
																<div style="font-family: sans-serif">
																	<div
																		style="font-size: 14px; mso-line-height-alt: 16.8px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
																		<p style="margin: 0; font-size: 14px;">
																			<span style="color: #696969; font-size: 14px;"><strong>O produto <b style="color: #93583a;"><?php echo $product; ?></b>
																					da empresa <b style="color: #93583a;"><?php echo $supplier; ?></b> com CNPJ <b style="color: #93583a"><?php echo $cnpj; ?></b> foi aprovado. 
																					Efetuado no dia <?php echo date('d/m/Y', strtotime($date)); ?> às <?php echo date('H:i', strtotime($date)); ?>.
																			</strong></span>
																		</p>
																	</div>
																</div>
																...
																<div style="font-family: sans-serif">
																	<div
																		...
																		<p
																			...
																			<span style="color: #93583a; font-size: 14px;"><a
																		...
																		<p
																			...
																			<span style="color: #696969; font-size: 14px;">Contato:<strong>
																					(41) 3019-9194</strong> OU <strong>atendimento@centraldacerveja.com.br</strong></span>
																		</p>
																	</div>
																</div>
															</td>
