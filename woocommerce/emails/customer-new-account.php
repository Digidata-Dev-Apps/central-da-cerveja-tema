											...
											<tr>
												<td class="column" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; padding-top: 5px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													...
													<table class="heading_block" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td style="width:100%;text-align:center;padding-top:30px;">
																<h1 style="margin: 0; color: #93583a; font-size: 23px; font-family: 'Gotham Bold', Calibri, sans-serif; line-height: 120%; text-align: left; direction: ltr; font-weight: normal; letter-spacing: normal; margin-top: 0; margin-bottom: 0;">Bem vindo à Central da Cerveja</h1>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td style="padding-top:40px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
																<div style="font-family: 'Gotham Bold', Calibri, sans-serif">
																	<div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #696969; line-height: 1.2; font-family: 'Gotham Bold', Calibri, sans-serif;">
																		<p style="margin: 0; font-size: 14px; mso-line-height-alt: 16.8px;">&nbsp;</p>
																		<p style="margin: 0; font-size: 14px;">

																			Obrigado por criar uma conta em Central da Cerveja. Você pode acessar sua conta para ver pedidos, alterar sua senha e muito mais em: <a style="box-sizing: border-box; font-weight: normal; text-decoration: underline; color: #93583a;" href="<?php echo esc_url(wc_get_page_permalink('myaccount')) ?>"><?php echo wc_get_page_permalink('myaccount') ?></a>
													...
													<table class="html_block" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td>
																<div style="font-family:'Gotham Bold', Calibri, sans-serif;" align="center">
																	<table border="0" cellpadding="10" cellspacing="0" class="divider_block" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
																		<tr>
																			<td>
																				<div>
