                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" class="image_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
                                                        <tr>
                                                            <td style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div style="line-height:10px"><img src="images/CentralDaCerveja-Logo.png" style="display: block; height: auto; border: 0; width: 155px; max-width: 100%;" width="155" /></div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                                    ...
                                                                    <table border="0" cellpadding="10" cellspacing="0" style="border: 1px solid rgba(0,0,0,.1); margin: 0 -1px 24px 0; text-align: left; width: 100%; border-collapse: separate; border-radius: 5px; border: 1px solid rgba(0, 0, 0, 0.1); margin: 0 -1px 24px 0; text-align: left; width: 100%; border-collapse: collapse; border-radius: 5px;">
                                                                        <thead>
                                                                            <tr style="background: #93583a; border: none !important; border-collapse: collapse; font-size: 16px;">
                                                                                ...
                                                                                <th align="center">
                                                                                    <div style="color: #fff;">Pedido
                                                                                    </div>
                                                                                </th>
                                                                                <th align="center">
                                                                                    <div style="color: #fff;">Valor
                                                                                    </div>
                                                                                </th>
                                                                                <th align="center">
                                                                                    <div style="color: #fff;">Qtd.
                                                                                    </div>
                                                                                </th>
                                                                                <th align="center">
                                                                                    <div style="color: #fff;">Data de Validade
                                                                                    </div>
                                                                                </th>
                                                                            </tr>
                                                                        </thead>
                                                                        ...
                                                                        <tfoot style="border-color: inherit; border-style: solid; border-width: 0;">
                                                                            ...
                                                                            <tr style="font-size: 16px; font-family: Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                                                ...
                                                                                <td align="center" data-title="Total" style="font-weight: bold; padding: 1em !important; border: none !important; border-collapse: collapse;" colspan="2">
                                                                                    <p style="font-size: 16px; font-family: 'Gotham Bold', Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                                                        <span>SubTotal: <?php echo wc_price($order->get_total() - $order->get_total_tax() - $order->get_total_shipping() - $order->get_shipping_tax()) ?></span>
