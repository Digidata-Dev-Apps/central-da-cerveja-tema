                                                    ...
                                                    <table class="heading_block" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
                                                        <tr>
                                                            <td style="width:100%;text-align:center;">
                                                                <h1 style="margin: 0; color: #93583a; font-size: 23px; font-family: 'Gotham Bold', sans-serif; line-height: 120%; text-align: left; direction: ltr; font-weight: normal; letter-spacing: normal; margin-top: 0; margin-bottom: 0;"><strong>Solicitação de compra de barril.</strong></h1>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                            ...
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div style="font-size: 12px; mso-line-height-alt: 14.399999999999999px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                                        <p style="margin: 0; font-size: 12px;"><span style="font-size:14px;"><strong>Data e Hora do Pedido: </strong>
                                                                                <?php
                                                                                $date = explode(' ', $_POST['order_date']);
                                                                                echo $date[0] . ' às ' . $date[1];
                                                                                ?></span></p>
                                                                        <p style="margin: 0; font-size: 12px;"><span style="font-size:14px;">
                                                            ...
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                                        <p style="margin: 0; font-size: 14px;"><strong>Detalhes do Pedido:</strong></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                                    ...
                                                                    <div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                                        <p style="margin: 0; font-size: 14px;">
                                                                            ...
                                                                            <?php if(isset($_POST['user_id'])): ?>
                                                                                <a class="see-user-details" href="<?php echo home_url(); ?>/wp-admin/user-edit.php?user_id=<?php echo $_POST['user_id']; ?>"><?php echo $_POST['name']; ?></a></span>
                                                                            <?php else: ?>
                                                                                <?php echo $_POST['name']; ?>
                                                                            <?php endif; ?>
                                                                        </p>
                                                    ...
                                                    <table class="text_block" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                        <tr>
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                                        <p style="margin: 0; font-size: 14px;"><strong>Data para Entrega: </strong> <?php echo date('d/m/Y', strtotime($_POST['delivery_date'])); ?></p>
                                                                        <p style="margin: 0; font-size: 14px;"><strong>Estado: </strong> <?php echo $_POST['state']; ?></p>
                                                                        <p style="margin: 0; font-size: 14px;"><strong>Município: </strong> <?php echo $_POST['city']; ?></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="text_block" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                        <tr>
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                                        <p style="margin: 0; font-size: 14px;"><strong>Quantidade de Litros:</strong> <?php echo  $_POST['liters']; ?></p>
                                                                        <p style="margin: 0; font-size: 14px;"><strong>Estilo do Chopp:</strong> <?php echo !empty($_POST['style']) ? $_POST['style'] : '--'; ?></p>
                                                                        <p style="margin: 0; font-size: 14px;"><strong>Cervejarias de Preferência:</strong> <?php echo !empty($_POST['suppliers']) ? implode(', ', $_POST['suppliers']) : '--'; ?></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="text_block" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                        <tr>
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                                        <p style="margin: 0; font-size: 14px;"><strong>Informações da Solicitação:</strong></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="text_block" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                        <tr>
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                                        <p style="margin: 0; font-size: 14px;"><?php echo $_POST['request_info']; ?></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="text_block" width="100%" border="0" cellpadding="10" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;">
                                                        <tr>
                                                            <td>
                                                                <div style="font-family: sans-serif">
                                                                    <div style="font-size: 14px; mso-line-height-alt: 16.8px; color: #393d47; line-height: 1.2; font-family: Arial, Helvetica Neue, Helvetica, sans-serif;">
                                                                        <p style="margin: 0; font-size: 14px;"><?php echo $_POST['request_details']; ?></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
