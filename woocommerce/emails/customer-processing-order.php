                                                ...
                                                <td class="column"
                                                                ...
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <div
                                                                        ...
                                                                        <p
                                                                            ...
                                                                            <span style="font-size:20px;">Pedido Está sendo Processado</span></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <td style="padding-top:35px;">
                                                                <div align="center"
                                                                    ...
                                                                    <table border="0" cellpadding="10" cellspacing="0"
                                                                        ...
                                                                        <thead>
                                                                            <tr
                                                                                style="background: #93583a; border: none !important; border-collapse: collapse;">
                                                                                <th align="center">
                                                  ...
                                                  <table border="0" cellpadding="10" cellspacing="0" style="box-sizing: border-box; border: 1px solid rgba(0, 0, 0, 0.1); margin: 0 -1px 24px 0; text-align: left; width: 100%; border-collapse: collapse; border-radius: 5px;">
                                                    <thead style="box-sizing: border-box;">
                                                        <tr style="box-sizing: border-box; background: #93583a; border-collapse: collapse; border: none;">
                                                        ...
                                                        <tr style="font-size: 16px; font-family: Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                            ...
                                                            <td align="center" data-title="Total"
                                                                ...
                                                                <p style="font-size: 16px; font-family: 'Gotham Bold', Calibri, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                                    ...
                                                                    <?php endif; ?>
                                                                    <br><span>Frete: <?php echo ($order->get_total_shipping() > 0) ? wc_price($order->get_meta('shipping_total_value', true )) : '<font color="#FF0000">Frete Grátis</font>' ?></span>
                                                            ...
                                                            <tr style="box-sizing: border-box;">
                                                                <td valign="top" width="50%"
                                                                    ...
                                                                    <address class="address"
                                                                        style="box-sizing: border-box; padding: 12px; color: #636363; border: 1px solid #e5e5e5;">
