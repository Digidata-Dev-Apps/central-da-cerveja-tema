                                                                ...
                                                                <div style="font-family: Tahoma, Verdana, sans-serif">
                                                                    <div style="font-size: 12px; font-family: 'Roboto', Tahoma, Verdana, Segoe, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #93583a; line-height: 1.2;">
                                                                        <p style="margin: 0; font-size: 12px; letter-spacing: normal;">
                                                                            <span style="font-size:20px;">Parabéns você recebeu uma indicação para receber um desconto de <?php echo $args['discount'] ?> em compra de uma assinatura.</span>
                                                                        </p>
                                                                        <p><a style="text-align: center;
                                                                            ...
                                                                            box-shadow: none;
                                                                            text-shadow: none;
                                                                            background: #f8a924 !important;
                                                                            border-radius: 0px !important;
                                                                            width: 100%;
                                                                            text-transform: uppercase;
                                                                            height: 36px;
                                                                            text-transform: uppercase;" href="<?php echo $args['url'] ?>">Acessar</a></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
